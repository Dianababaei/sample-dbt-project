...
create or replace transient table BAIN_ANALYTICS.DEV.fact_fund_summary
...
with fund_rollup as (
    select * from BAIN_ANALYTICS.DEV.int_fund_rollup
),

fund_hierarchy as (
    select * from BAIN_ANALYTICS.DEV.stg_fund_hierarchy
),
